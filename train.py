...
class StatusWindow:
    ...
    def __init__(self, title: str):
        ...
        self._fields = [
            ...
            ("Painting", "painting_reward"),
            ("Frontier", "frontier_reward"),
            ("Key Reward", "key_reward"),
            ("Key Approach", "key_approach_reward"),
            ("Level Reward", "level_reward"),
            ("Life Penalty", "life_penalty"),
            ("Visited Cells", "visited_cells"),
            ("Guardian X", "h_guard_x_cell"),
...
class StatusWindowCallback(BaseCallback):
    ...
    def _on_step(self) -> bool:
        ...
        values = {
            ...
            "painting_reward": info.get("painting_reward", "-"),
            "frontier_reward": info.get("frontier_reward", "-"),
            "key_reward": info.get("key_reward", "-"),
            "key_approach_reward": info.get("key_approach_reward", "-"),
            "level_reward": info.get("level_reward", "-"),
            "life_penalty": info.get("life_penalty", "-"),
            "visited_cells": info.get("visited_cells", "-"),
            "h_guard_x_cell": state.get("h_guard_x_cell", "-"),
